...
$services = $this->entity->get_service_schedule($date11,$date22,$requestid,"","");
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <div class="row">
		<div class="col-md-5"><h5 class="text-primary" style="font-size:24px;font-weight:500">Service Schedule Logs</h5></div>
		<!--
      ...
      <div class="box">
        <div class="box-body">
			...
			<?php
				...
				echo form_open('cpanel/service_schedule', $attributes);
			?>
			...
			?>
							...
							<tr id="rholder<?=$rowz['id']?>">
								<td data-th="#"><?=$i?></td>
								<td data-th="Request ID">000<?=$rowz['service_request_id']?></td>
								<td data-th="Customers" id="customers<?=$rowz['id']?>"><?=$rowz['usernames']?></td>
								<td data-th="Technician" id="technician<?=$rowz['id']?>"><?=$rowz['last_name']." ".$rowz['first_name']?></td>
								<td data-th="start date" id="start_date<?=$rowz['id']?>"><?=$this->utilities->system_date($rowz['start_date'],2)?></td>
								<td data-th="Status"><?=$this->utilities->get_status_style($rowz['service_status'])?></td>
								<td>
									<!--
